...
const FormDetails: React.FC<FormDetailsProps> = ({ projects }) => {
              ...
              >
                <dl className="grid sm:block lg:grid xl:block grid-cols-2 grid-rows-2 items-center">
                  <div>
                    ...
                    <dd className="group-hover:text-white font-semibold text-slate-900">{project.title}</dd>
                  </div>
                  <div>
                  ...
                  <div className="col-start-2 row-start-1 row-end-3 sm:mt-4 lg:mt-0 xl:mt-4">
                    ...
                    <dd className="-space-x-1.5 flex justify-end sm:justify-start lg:justify-end xl:justify-start">
